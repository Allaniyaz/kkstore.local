        ...
        <div class="container">
            <div class="row">
                ...
                @foreach($products as $product)
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ url('storage/' . $product->images[0]) }}">
    ...
    <section class="featured spad">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        ...
                        @foreach ($categories as $cat)
                            <li data-filter=".{{ mb_strtolower($cat->name) }}">{{ $cat->name }}</li>
                        @endforeach
                        </ul>
                    </div>
                </div>
            ...
            @foreach($latest as $late)
                <div class="col-lg-3 col-md-4 col-sm-6 mix {{ mb_strtolower($late->category->name) }}">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{ url('storage/'.$late->images[0]) }}">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li class='addCart'><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <div class="featured__item__text">
                            <h6><a href="{{ route('products.show', $late->id) }}">{{ $late->name }}</a></h6>
                            <h5>${{ $late->price }}</h5>
                        </div>
                    </div>
                </div>
                            ...
                            @endif
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{ url('storage/' . $late->images[0]) }}" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>{{ $late->name }}</h6>
                                        <span>${{ $late->price }}</span>
                                    </div>
                                </a>
                            @if ($i % 3 == 1)
                                </div>
